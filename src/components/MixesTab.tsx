                ...
                return (
                  ...
                  >
                    ...
                    >
                      {isActive && (
                        <motion.div 
                          className="absolute top-0 right-0 bg-white text-black text-xs font-bold py-1 px-3 rounded-bl-lg rounded-tr-lg"
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-full text-left pr-2">
                        {isActive && (
                          <motion.div 
                            className="absolute top-0 right-10 bg-white text-black text-xs font-bold py-1 px-3 rounded-bl-lg rounded-tr-lg z-10"
                            initial={{ opacity: 0, scale: 0.8 }}
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.3 }}
                          >
